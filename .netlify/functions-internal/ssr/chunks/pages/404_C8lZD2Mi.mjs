...
/* empty css                          */
import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as createTransitionScope, j as renderComponent, k as renderSlot, l as renderTransition, n as renderHead } from '../astro_n4vsnFKN.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                        */
import { i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_CO8UotDi.mjs';
/* empty css                        */
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CO8UotDi.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					const outDir = new URL("file:///C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/dist/");
					new URL("_astro", outDir);
					const getImage = async (options) => await getImage$1(options, imageConfig);

const web_name = "JC International";
...
const $$ThemeIcon = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$4 || (_a$4 = __template$4(["", '<span class=" bg-primary dark:bg-secondary rounded-lg p-5 md:pl-2 md:pr-2 md:pt-[5px]  text-center pb-0" data-astro-cid-htzy5xbu> <button class="rounded-lg" id="themeToggle" data-astro-cid-htzy5xbu', `> <svg width="1em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-astro-cid-htzy5xbu> <path class="sun" fill-rule="evenodd" d="M12 17.5a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zm0 1.5a7 7 0 1 0 0-14 7 7 0 0 0 0 14zm12-7a.8.8 0 0 1-.8.8h-2.4a.8.8 0 0 1 0-1.6h2.4a.8.8 0 0 1 .8.8zM4 12a.8.8 0 0 1-.8.8H.8a.8.8 0 0 1 0-1.6h2.5a.8.8 0 0 1 .8.8zm16.5-8.5a.8.8 0 0 1 0 1l-1.8 1.8a.8.8 0 0 1-1-1l1.7-1.8a.8.8 0 0 1 1 0zM6.3 17.7a.8.8 0 0 1 0 1l-1.7 1.8a.8.8 0 1 1-1-1l1.7-1.8a.8.8 0 0 1 1 0zM12 0a.8.8 0 0 1 .8.8v2.5a.8.8 0 0 1-1.6 0V.8A.8.8 0 0 1 12 0zm0 20a.8.8 0 0 1 .8.8v2.4a.8.8 0 0 1-1.6 0v-2.4a.8.8 0 0 1 .8-.8zM3.5 3.5a.8.8 0 0 1 1 0l1.8 1.8a.8.8 0 1 1-1 1L3.5 4.6a.8.8 0 0 1 0-1zm14.2 14.2a.8.8 0 0 1 1 0l1.8 1.7a.8.8 0 0 1-1 1l-1.8-1.7a.8.8 0 0 1 0-1z" data-astro-cid-htzy5xbu></path> <path class="moon" fill-rule="evenodd" d="M16.5 6A10.5 10.5 0 0 1 4.7 16.4 8.5 8.5 0 1 0 16.4 4.7l.1 1.3zm-1.7-2a9 9 0 0 1 .2 2 9 9 0 0 1-11 8.8 9.4 9.4 0 0 1-.8-.3c-.4 0-.8.3-.7.7a10 10 0 0 0 .3.8 10 10 0 0 0 9.2 6 10 10 0 0 0 4-19.2 9.7 9.7 0 0 0-.9-.3c-.3-.1-.7.3-.6.7a9 9 0 0 1 .3.8z" data-astro-cid-htzy5xbu></path> </svg> </button> </span>  <script>    
function  setDarkMode(){
  ...
  <\/script>`])), maybeRenderHead(), addAttribute(createTransitionScope($$result, "cd6zn5qu"), "data-astro-transition-persist"));
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/components/ui/ThemeIcon.astro", "self");
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$3 || (_a$3 = __template$3(["", '<header id="header-nav" class=" dark:bg-secondary bg-primary  text-secondary dark:text-primary  md:bottom-auto bottom-0 w-full fixed z-40 border-gray-200   " data-astro-cid-3ef6ksr2', '> <div class="max-w-screen flex flex-col md:flex-row md:flex-wrap flex-nowrap items-center justify-evenly mx-10 p-4" data-astro-cid-3ef6ksr2> <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse" data-astro-cid-3ef6ksr2> <!-- <svg class="text-third "  xmlns="http://www.w3.org/2000/svg" width="3.2em" height="3.2em" viewBox="0 0 48 66"><g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path fill="currentColor" fill-rule="evenodd" stroke="#000" d="M17 14L44 24V44H17L17 14Z" clip-rule="evenodd"/><path stroke="#000" d="M17 14L4 24L4 44H17"/><path stroke="#fff" d="M35 44V32L26 29L26 44"/><path stroke="#000" d="M44 44H17"/></g></svg> --> <img class="w-16" src="/logo.png" alt="" data-astro-cid-3ef6ksr2> <span class="self-center text-2xl font-semibold whitespace-nowrap  " data-astro-cid-3ef6ksr2> ', '</span> </a> <!-- toogle navbar mobiles --> <button id="mobile-menu-toggle" type="button" class=" absolute right-4 bottom-6 items-center p-2 w-10 h-10 justify-center text-sm  rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200  dark:hover:bg-gray-700 dark:focus:ring-gray-600" data-astro-cid-3ef6ksr2> <span class="sr-only" data-astro-cid-3ef6ksr2>Open main menu</span> <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24" data-astro-cid-3ef6ksr2><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2" data-astro-cid-3ef6ksr2><path d="M5 5L12 12L19 5" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="d" dur="0.4s" values="M5 5L12 12L19 5;M5 5L12 5L19 5" data-astro-cid-3ef6ksr2></animate></path><path d="M12 12H12" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="d" dur="0.4s" values="M12 12H12;M5 12H19" data-astro-cid-3ef6ksr2></animate></path><path d="M5 19L12 12L19 19" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="d" dur="0.4s" values="M5 19L12 12L19 19;M5 19L12 19L19 19" data-astro-cid-3ef6ksr2></animate></path></g></svg> </button> <div class="hidden w-full md:block md:w-auto" id="navbar-default" data-astro-cid-3ef6ksr2> <ul class="font-medium flex flex-col p-4 md:p-0 mt-4  rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 " data-astro-cid-3ef6ksr2> <li data-astro-cid-3ef6ksr2> <a href="/" class="block py-2 px-3 rounded md:bg-transparent  md:p-0 " aria-current="page" data-astro-cid-3ef6ksr2> <svg class="" xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24" data-astro-cid-3ef6ksr2><rect width="4" height="8" x="10" y="13" fill="currentColor" fill-opacity="0" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="fill-opacity" begin="0.9s" dur="0.15s" values="0;0.3" data-astro-cid-3ef6ksr2></animate></rect><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-3ef6ksr2><path stroke-dasharray="15" stroke-dashoffset="15" d="M4.5 21.5h15" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="stroke-dashoffset" dur="0.2s" values="15;0" data-astro-cid-3ef6ksr2></animate></path><path stroke-dasharray="15" stroke-dashoffset="15" d="M4.5 21.5V8M19.5 21.5V8" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.2s" dur="0.2s" values="15;0" data-astro-cid-3ef6ksr2></animate></path><path stroke-dasharray="24" stroke-dashoffset="24" d="M9.5 21.5V12.5H14.5V21.5" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.4s" dur="0.4s" values="24;0" data-astro-cid-3ef6ksr2></animate></path><path stroke-dasharray="30" stroke-dashoffset="30" stroke-width="2" d="M2 10L12 2L22 10" data-astro-cid-3ef6ksr2><animate fill="freeze" attributeName="stroke-dashoffset" begin="0.5s" dur="0.4s" values="30;0" data-astro-cid-3ef6ksr2></animate></path></g></svg> </a> </li> ', " <!-- dark mode toggle button --> ", ` </ul> </div> </div> </header> <script>
...
<\/script>`])), maybeRenderHead(), addAttribute(createTransitionScope($$result, "7zjuvqpw"), "data-astro-transition-persist"), clientData.web_name, headerNavs.map((nav) => renderTemplate`<li data-astro-cid-3ef6ksr2> <a${addAttribute(nav.url, "href")} class="block py-2 capitalize px-3  rounded md:bg-transparent  md:p-0 " aria-current="page" style="    text-transform: capitalize;" data-astro-cid-3ef6ksr2> ${nav.label} </a> </li>`), renderComponent($$result, "ThemeIcon", $$ThemeIcon, { "data-astro-cid-3ef6ksr2": true }));
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/components/Header.astro", "self");
...
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/components/icons/Whatsapp.astro", void 0);
...
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/components/icons/Mail.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(['<html lang="en"> <head><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Lora:wght@400;700&display=swap"><!-- flowbite link --><link href="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.1/flowbite.min.css" rel="stylesheet"><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta', "", '><meta name="google-site-verification" content="fGktjHCQjBR4YHgvqwZHd9gLTJY6134Ws_WQqk2XMX4"><title>', " | ", "</title><!-- <ViewTransitions /> -->", "</head> <body", "", "> ", ' <main class="mx-auto p-0"> <div> ', " </div> ", " ", ` </main> <!-- flowbite scripts --> <!-- <script is:inline src="../path/to/flowbite/dist/flowbite.min.js"><\/script> --> <script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.2.1/flowbite.min.js"><\/script> <script>
        ...
        <\/script> <!-- Dark Theme  funtionality --> <script>
            function darkMode() {
        ...
        <\/script> <!-- Dark Theme  funtionality --> <script>
            ...
            document.addEventListener('astro:after-swap', () => (darkMode()));
        <\/script> <!-- swiper bundle --> <!-- Add this script tag to your HTML --> <script src="https://unpkg.com/swiper/swiper-bundle.min.js"><\/script> <!-- cliente supabase -->  <!-- or -->  </body> </html>`])), addAttribute(title, "name"), addAttribute(description, "content"), title, subtitle, renderHead(), addAttribute(renderTransition($$result, "evdsgkz7", "slide", ""), "data-astro-transition-scope"), addAttribute(createTransitionScope($$result, "evdsgkz7"), "data-astro-transition-persist"), renderComponent($$result, "Header", $$Header, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}), renderComponent($$result, "FloatingButtons", $$FloatingButtons, {}));
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/layouts/layout.astro", "self");
...
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/components/CADD/Mensaje.astro", void 0);
...
}, "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/pages/404.astro", void 0);

const $$file = "C:/Users/CASTELL/Documents/GitHub/ASTRO/jcinternacionalrealtygroup/src/pages/404.astro";
const $$url = "/404";
...
export { $$Layout as $, _404 as _, clientData as c, getConfiguredImageService as g, imageConfig as i };
